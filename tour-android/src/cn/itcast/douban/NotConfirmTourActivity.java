...
public class NotConfirmTourActivity extends BaseActivity implements
		OnClickListener {
	...
	private static final int EDIT_NOTE = 11;
	...
	protected void findView() {
		...
		edit_button = (ImageButton) this.findViewById(R.id.edit_button);
		...
		lv.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				AlertDialog.Builder builder = new Builder(
						NotConfirmTourActivity.this);
				String[] items = { "查看营业数据", "删除营业数据", "确认营业数据" };
				builder.setItems(items, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 0:
							...
							break;
						case 1:
							deleteOrConfirmTour(tour.getId().toString(), "deleteTourWs");
							break;
						case 2:
							deleteOrConfirmTour(tour.getId().toString(), "doConfirmTourWs");
							break;
						}
		...
		new AsyncTask<String, Void, String>() {
			...
			protected void onPostExecute(String result) {
				...
				if (result != null && !"".equals(result.trim())) {
					Intent intent = new Intent(NotConfirmTourActivity.this.getApplicationContext(),
	...
	private void deleteOrConfirmTour(String id, String methodName) {
		...
		new AsyncTask<String, Void, String>() {
			...
			protected void onPostExecute(String result) {
				...
				isloading = false;
				hideLoading();
				if (result != null && !"".equals(result.trim()) && Boolean.parseBoolean(result)) {
					fillData();
				} else {
					MyToast.showToast(getApplicationContext(), "执行失败", 0);
				}
			...
			protected String doInBackground(String... params) {
				Map<String, String> argument = new HashMap<String, String>();
				argument.put("id", params[0]);				
				String json = NetUtils.callWs("tourService", params[1], argument);
				return json;
				
			}

		}.execute(id, methodName);
	...
	private void fillData() {
		new AsyncTask<Void, Void, PageResult>() {
			...
			protected PageResult doInBackground(Void... params) {
				...
				DoubanApplication myapp = (DoubanApplication) NotConfirmTourActivity.this
						.getApplication();
				String userId = myapp.currentUser.getId().toString();

				Map<String, String> argument = new HashMap<String, String>();
				argument.put("userId", userId);
				argument.put("status", StatusEnum.notReport.getValue()
						.toString());
				argument.put("start", NotConfirmTourActivity.this.startIndex
						+ "");
				argument.put("pageSize",
						NotConfirmTourActivity.this.pageSize.toString());
